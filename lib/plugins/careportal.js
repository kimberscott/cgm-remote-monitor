...
function init() {
  ...
  careportal.getEventTypes = function getEventTypes () {
    ...
    return [
        { val: 'Meal Bolus'
        , name: 'Carb entry'
        , bg: false,  insulin: false,  carbs: true,  prebolus: true,  duration: false, percent: false, absolute: false, profile: false, split: false, sensor: false
      }
      , { val: 'Correction Bolus'
        , name: 'Bolus entry'
        , bg: false,  insulin: true,  carbs: false,  prebolus: false,  duration: false, percent: false, absolute: false, profile: false, split: false, sensor: false
      }
      , { val: 'Note'
        , name: 'Note'
      ...
      , { val: 'Sensor Start'
        ...
        , bg: false,  insulin: false, carbs: false, prebolus: false, duration: false, percent: false, absolute: false, profile: false, split: false, sensor: false
      }
