...
function init (ctx) {
  ...
  openaps.getEventTypes = function getEventTypes (sbx) {
    ...
    if (units == 'mmol') {
    	...
    	reasonconf.push({ name: translate('Disable SMB'), targetTop: 5.7, targetBottom: 5.7, duration: 90 });
    } else {
    	...
    	reasonconf.push({ name: translate('Disable SMB'), targetTop: 101, targetBottom: 101, duration: 90 });  
    }
