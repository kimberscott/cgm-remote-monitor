...
function init (ctx) {
  ...
  openaps.getEventTypes = function getEventTypes (sbx) {
    ...
    var reasonconf = [];
    var reasonconfHighTemp = [];

    if (units == 'mmol') {
    	reasonconf.push({ name: translate('Recover after low'), targetTop: 8.4, targetBottom: 8.4, duration: 150 });
    	...
    	reasonconfHighTemp.push({ name: translate('Disable SMB'), targetTop: 5.7, targetBottom: 5.7, duration: 90 });
    } else {
    	reasonconf.push({ name: translate('Recover after low'), targetTop: 150, targetBottom: 150, duration: 150 });  
    	...
    	reasonconfHighTemp.push({ name: translate('Disable SMB'), targetTop: 101, targetBottom: 101, duration: 90 });  
    }
